...
export declare class MaintenanceRecordsRepository {
    ...
    findAll(page?: number, limit?: number, search?: string, sortBy?: string, order?: 'ASC' | 'DESC', carId?: number, itemId?: number, startDate?: string, endDate?: string): Promise<[MaintenanceRecord[], number]>;
